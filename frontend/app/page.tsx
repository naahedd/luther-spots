    ...
    return (
        <main className="flex flex-col sm:flex-row sm:gap-4 h-screen">
            <div className="basis-2/5 sm:h-full order-last sm:order-first py-4 sm:px-0 sm:py-2 overflow-hidden sm:flex sm:flex-col">
                <div className="w-full h-20 pl-0 pr-4 hidden sm:flex sm:justify-between items-center">
                    <Image
                        src={"/luther.png"}
                        width={200}
                        height={200}
                ...
                <ScrollArea className="h-full">
                    <div className="w-full h-20 pl-2 pr-8 flex sm:hidden justify-between items-center">
                        <Image
                            src={"/luther.png"}
                            width={180}
                            height={200}
